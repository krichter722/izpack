 ...
 *
 * <p>
 * The mapping matches URLs using the following rules:<br> <ul> <li>? matches
 ...
 * Some examples:<br>
 * <ul>
 * <li><code>bin/t?st.exe</code> - matches <code>bin/test.exe</code> but also
 * <code>bin/tast.exe</code> or <code>bin/txst.exe</code></li>
 * <li><code>bin/*.exe</code> - matches all <code>.exe</code> files in the
 * <code>bin</code> directory</li>
 * <li><code>bin/&#42;&#42;/test.exe</code> - matches all <code>test.exe</code>
 * files underneath the <code>bin</code> path</li>
 * </ul>
 */
public class AntPathMatcher
{
    ...
    /**
     * This function unifies variable references by replacing references in the
     * form of ${...} with $...
     *
     * @param input the string that may contain variable references to be
     * replaced
