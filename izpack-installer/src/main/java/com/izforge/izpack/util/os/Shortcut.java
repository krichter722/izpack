...
public abstract class Shortcut
{
    ...
    /**
     * NORMAL = 1 Show the window 'normal' when starting. Usually restores the
     * window properties at the last shut-down.
     */
     ...
     * only if the instance was created from a file on disk or after a
     ...
     * <code>false</code> if this is not supported.
     */
    ...
    /**
     * Gets the Programs Folder for the given User. This is where to create
     * subfolders or to place or create shortcuts.
     *
     * @param currentUser one of current or all
     * @return The Foldername or null on unsupported platforms.
     */
    public abstract String getProgramsFolder(int currentUser);
