...
public class SummaryProcessor
{
    ...
    private static final String BODY_START = "<div class=\"body\">";

    private static final String BODY_END = "</div>";

    private static final String HEAD_START = "<h1>";

    private static final String HEAD_END = "</h1>\n";
     ...
     * To get the summary, the methods *
     * {@link com.izforge.izpack.api.installer.ISummarisable#getSummaryCaption}
     * and
     * {@link com.izforge.izpack.api.installer.ISummarisable#getSummaryBody()}
     * of all panels are called.
     *
