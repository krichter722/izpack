...
/**
 * Verifies that the correct JDK version is available for installation to
 * proceed.
 *
 * @author Tim Anderson
 */
public class JDKChecker implements RequirementChecker
{
     ...
     *
     * @return <tt>true</tt> if JDK requirements are met, otherwise
     * <tt>false</tt>
     */
    @Override
    ...
    /**
     * Determines if the JDK is installed, by executing attempting to execute
     * javac.
     *
     * @return <tt>true</tt> if javac was successfully executed, otherwise
     * <tt>false</tt>
     */
     ...
     *
     * @return <tt>true</tt> if the user proceeds with the installation,
     * <tt>false</tt> if they cancel it
     */
