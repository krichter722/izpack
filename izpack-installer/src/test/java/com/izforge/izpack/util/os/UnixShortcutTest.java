...
public class UnixShortcutTest
{
    ...
    {
//        UnixShortcut aSample = new UnixShortcut(idata);
//        System.out.println(">>" + aSample.getClass().getName() + "- Test Main Program\n\n");

//        try
//        {
//            aSample.initialize(UnixShortcut.APPLICATIONS, "Start Tomcat");
//        }
//        catch (Exception exc)
//        {
...
//        System.out.println("DONE.\n");
    ...
    /**
     * Returns the value for the specified keyName in a string of key=value
     * lines.
     *
     * @param source
     * @param keyName
    ...
    public void testLink() throws Exception
    {
        ...
        UnixShortcut shortcut = (UnixShortcut) factory.create(Shortcut.class, platform);
