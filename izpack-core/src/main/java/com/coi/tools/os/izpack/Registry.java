...
/**
 * Wrapper class for com.coi.tools.os.win.RegistryImpl for using it with IzPack.
 * This class implements only the methods of interface NativeLibraryClient. All
 * other methods are used directly from RegistryImpl.
 *
 * @author Klaus Bartz
 */
public class Registry extends RegistryImpl implements NativeLibraryClient
{
    ...
    /**
     * This method is used to free the library at the end of program execution.
     * This class has no own library else it shares it in the COI common lib. To
     * free the library, the helper class is called. After this call, any
     * instance of this class will not be usable any more! <b><i>
     * <u>Note that this method does NOT return </u> at the first call, but at
     * any other </i> </b>
     * <br>
     * <br>
