...
public class RegistryHandler implements MSWinConstants
{
     ...
     * registry value does not exist, it will be created.
     *
     ...
     * (achieved via 'false'). If this method is not called then the flag wll
     * default to 'true'.
     *
    ...
    /**
     * Registers logging information. This replaces any existing logging
     * information.
     *
