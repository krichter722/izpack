        ...
        implements FileScanner, /*SelectorScanner, */ ResourceFactory
{
     ...
     * patterns will not become part of this array that has only been kept
     * around for backwards compatibility reasons.</p>
     *
    ...
    /**
     * Test whether or not a given path matches the start of a given pattern up
     * to the first "**".
     * <p/>
     ...
     *
     * @return An array of <code>String</code> based on the current contents of
     * the <code>defaultExcludes</code> <code>Vector</code>.
     */
    ...
    /**
     * Add a pattern to the default excludes unless it is already a default
     * exclude.
     *
     ...
     * @return <code>true</code> if <code>s</code> was a default exclude (and
     * thus was removed); <code>false</code> if <code>s</code> was not in the
    ...
    /**
     * Add to the list of exclude patterns to use. All '/' and '\' characters
     ...
     *
     * @throws Exception if the base directory was set incorrectly (i.e. if it
     * is <code>null</code>, doesn't exist, or isn't a directory).
     */
    ...
    /**
     * This routine is actually checking all the include patterns in order to
     * avoid scanning everything under base dir.
     */
     ...
     * of excluded/included files/directories, whereas a fast scan will only
     * have full results for included files, as it ignores directories which
     * can't possibly hold any included files/directories.
     * <p/>
     ...
     * first ** or the end of the pattern.
     * <p/>
     ...
     * ultimately included.</p>
     * <p/>
     * <p>
     * The names are relative to the base directory. This involves performing a
     * slow scan if one has not already been completed.</p>
     *
    ...
    /**
     * <p>
     * Return the names of the directories which were selected out and therefore
     * not ultimately included.</p>
     * <p/>
     * <p>
     * The names are relative to the base directory. This involves performing a
     * slow scan if one has not already been completed.</p>
    ...
    /**
     * Return a cached result of list performed on file, if available. Invokes
     * the method and caches the result otherwise.
     *
    ...
    /**
     * From <code>base</code> traverse the filesystem in order to find a file
    ...
    /**
     * From <code>base</code> traverse the filesystem in order to find a file
     * that matches the given stack of names.
     *
     * @param base base File (dir).
    ...
    /**
     * Has the directory with the given path relative to the base directory
    ...
    /**
     * This method is of interest for testing purposes. The returned Set is live
