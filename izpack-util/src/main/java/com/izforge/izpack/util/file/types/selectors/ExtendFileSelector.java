 ...
 * interfaces, the FileSelector and the Paramterizable interface. Note that you
 * will almost certainly want the default behaviour for handling Parameters, so
 * you probably want to use the BaseExtendSelector class as the base class for
 * your custom selector rather than implementing this interface from scratch.
 */
