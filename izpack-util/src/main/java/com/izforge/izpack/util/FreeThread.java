...
public class FreeThread extends Thread
{
     ...
     *
     * @param name the name of the library to free. The exact form of the name
     * may be operating system dependent. On Microsoft Windows this must be just
     * the library name, without path but with extension.
