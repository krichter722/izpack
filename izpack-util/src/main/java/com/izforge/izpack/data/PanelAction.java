...
public interface PanelAction
{
     ...
     * @param handler - actual UIHandler ( NOTE: On a preconstruct action the
     * handler is null because it is not available until it is constructed.
     * During an automated installation the handler is null on each action
     * because we have no GUI to handle.
     */
     ...
     *
     * @param configuration an PanelActionConfiguration containing the
     * configuration of the action or null if no configuration was found.
     */
