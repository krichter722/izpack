...
public interface LayoutConstants extends SwingConstants
{
    ...
    /**
     * Identifier for gaps between labels and controls like radio
     * buttons/groups.
     */
    ...
    /**
     * Identifier for gaps between controls like radio buttons/groups and
     * labels.
     */
    final static int CONTROL_TO_LABEL_GAP = -8;

    /**
     * Identifier for gaps between controls like radio buttons/groups and text
     * components.
     */
    final static int CONTROL_TO_TEXT_GAP = -9;

    /**
     * Identifier for gaps between text components and controls like radio
     * buttons/groups and labels
     */
    ...
    /**
     * Identifier for using the default alignment defined for labels. The value
     * will be resolved at layouting, therefore it is possible to change the
     * default values in </code>IzPanelConstraints</code>.
     */
     ...
     * The value will be resolved at layouting, therefore it is possible to
     * change the default values in </code>IzPanelConstraints</code>.
     */
    ...
    /**
     * Identifier for the default constraints for controls/container which are
     * variable in x and y dimension.
     */
    ...
    /**
     * Constant used to specify that no action should be done. Useable for X-
     * and Y_STRETCH.
     */
    public static final int NO_STRETCH = 0;

    /**
     * X- and Y_STRETCH constant used to specify relative weighting of stretch
     * factors.
     */
    public static final int RELATIVE_STRETCH = 1;

    /**
     * X- and Y_STRETCH constant used to specify absolute weighting of stretch
     * factors.
     */
    public static final int ABSOLUTE_STRETCH = 2;

    /**
     * X_STRETCH "symbolic" value to signal that the configurable default
     * stretch value should be used.
     */
    public static final double FULL_LINE_STRETCH = -1.0;

    /**
     * Y_STRETCH "symbolic" value to signal that the configurable default
     * stretch value should be used.
     */
    public static final double FULL_COLUMN_STRETCH = -2.0;

    /**
     * Object constant used as "constraint" at add a component to the IzPanel to
     * signal that this component should be place in the next line.
     */
    public static final String NEXT_LINE = "nextLine";

    /**
     * Flag used in the IzPanelLayout manager to trigger expansion of all
     * components to the netto width of a column.
     */
