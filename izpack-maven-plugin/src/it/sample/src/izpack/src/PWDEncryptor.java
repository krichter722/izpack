...
public class PWDEncryptor implements Processor {
     ...
     * demonstrates the use of this interface in a real installation
     * environment. For a real application a proper encryption mechanism must be
     * used. Though Java 1.4.X provides such algorithms, you need to consider
     * that not all potential target environments have this version installed.
     * It seems best to include the necessary encryption library with the
     * installer.
     *
