...
public class FieldHelper
{
    ...
    /**
     * Determines if a field is required if the field is required for the
     * current platform and selected packs.
     *
     * @param field the field
     * @param installData the installation data
     * @param matcher the platform-model matcher
     * @return {@code true} if the field is required for the current platform
     * and selected packs
     */
     ...
     * <p/>
     * An item is required if it has no pack constraints, or names one or more
     * selected packs.
     *
     * @param packNames the item's pack constraints. Each name corresponds to a
     * pack for which the item should be created if the pack is selected for
     * installation
     * @param selectedPacks the selected packs
     * @return {@code true} if {@code packs} is empty, or one of the packs
     * appears in {@code selectedPacks}
     */
     ...
     * <p/>
     * An item is required if it has no pack constraints, or doesn't name any
     * selected packs.
     *
     * @param packNames the item's pack constraints. Each name corresponds to a
     * pack for which the item should be created if the pack is not selected for
     * installation
     * @param selectedPacks the selected packs
     * @return {@code true} if {@code packs} is empty, or none of the packs
     * appears in {@code selectedPacks}
     */
