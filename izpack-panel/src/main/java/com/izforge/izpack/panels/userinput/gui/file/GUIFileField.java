 ...
 * @author Tim Anderson
 */
public class GUIFileField extends AbstractGUIFileField
{
    ...
    {
        super(field);
        FileFieldView view = new FileFieldView(field, prompt);
        init(new FileInputField(view, parent, installData));
    }
}
